...
public class StringDemo {
	...
	public static void main(String[] args) {
		...
		String num1="10";
		String num2="20";
		System.out.println(num1+num2);  //To print the value as a string
		System.out.println(Integer.parseInt(num1)+Integer.parseInt(num2));  //To print the value as an integer
